#ifndef _3D_UNICYCLE_PROPAGATOR_FIXEDK_
#define _3D_UNICYCLE_PROPAGATOR_FIXEDK_
...
class DynUnicycleControlSpace3DFixedK : public oc::StatePropagator {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        DynUnicycleControlSpace3DFixedK(const oc::SpaceInformationPtr &si, double processNoise, double R, double R_bad, double K_default, std::vector<std::vector<double > > measurement_regions);
