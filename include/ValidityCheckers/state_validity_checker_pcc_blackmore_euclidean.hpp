#ifndef OMPL_CONTRIB_STATE_VALIDITY_CHECKER_PCC_BLACKMORE_EUCLIDEAN_
#define OMPL_CONTRIB_STATE_VALIDITY_CHECKER_PCC_BLACKMORE_EUCLIDEAN_
...
class StateValidityCheckerPCCBlackmoreEuclidean : public ob::StateValidityChecker {
	public:
		StateValidityCheckerPCCBlackmoreEuclidean(const std::string &scene_id, const ob::SpaceInformationPtr &si, const double accep_prob);
		~StateValidityCheckerPCCBlackmoreEuclidean();
