...
#include "Scenario2ValidityChecker.hpp"

#include <iostream>
#include <cmath>

Scenario2ValidityChecker::Scenario2ValidityChecker(const ob::SpaceInformationPtr &si) :
    ob::StateValidityChecker(si)
{
}


bool Scenario2ValidityChecker::inCollision(const ob::State *state, 
                         double X1, double Y1, 
...
bool Scenario2ValidityChecker::inCollision(const ob::State *state) const{
...
bool Scenario2ValidityChecker::isValid(const ob::State *state) const
{
    // for each obstacles
...
Scenario2ValidityChecker::~Scenario2ValidityChecker()
{
