...
#ifndef OMPL_CONTRIB_STATE_VALIDITY_CHECKER_SCENARIO2EUCLIDEAN
#define OMPL_CONTRIB_STATE_VALIDITY_CHECKER_SCENARIO2EUCLIDEAN
...
*/
class EuclideanScenario2ValidityChecker : public ob::StateValidityChecker {

public:
    //! Scenario2ValidityChecker constructor.
    EuclideanScenario2ValidityChecker(const ob::SpaceInformationPtr &si);

    //! Scenario2ValidityChecker destructor.
    /*!
     * Destroy
     */
    ~EuclideanScenario2ValidityChecker();
