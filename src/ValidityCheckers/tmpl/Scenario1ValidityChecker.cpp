...
#include "Scenario1ValidityChecker.hpp"

#include <iostream>
#include <cmath>

Scenario1ValidityChecker::Scenario1ValidityChecker(const ob::SpaceInformationPtr &si) :
    ob::StateValidityChecker(si)
{
}


bool Scenario1ValidityChecker::inCollision(const ob::State *state, 
                         double X1, double Y1, 
...
bool Scenario1ValidityChecker::inCollision(const ob::State *state) const{
...
bool Scenario1ValidityChecker::isValid(const ob::State *state) const
{
    // for each obstacles
...
Scenario1ValidityChecker::~Scenario1ValidityChecker()
{
