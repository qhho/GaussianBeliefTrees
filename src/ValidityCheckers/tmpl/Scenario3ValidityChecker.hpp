...
#ifndef OMPL_CONTRIB_STATE_VALIDITY_CHECKER_SCENARIO3
#define OMPL_CONTRIB_STATE_VALIDITY_CHECKER_SCENARIO3
...
*/
class Scenario3ValidityChecker : public ob::StateValidityChecker {

public:
    //! Scenario3ValidityChecker constructor.
    Scenario3ValidityChecker(const ob::SpaceInformationPtr &si);

    //! Scenario3ValidityChecker destructor.
    /*!
     * Destroy
     */
    ~Scenario3ValidityChecker();
