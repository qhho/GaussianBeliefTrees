...
#include "MyValidityChecker.hpp"

#include <iostream>
#include <cmath>

MyValidityChecker::MyValidityChecker(const ob::SpaceInformationPtr &si) :
    ob::StateValidityChecker(si)
{
}


bool MyValidityChecker::inCollision(const ob::State *state, 
                         double X1, double Y1, 
...
bool MyValidityChecker::inCollision(const ob::State *state) const{
...
bool MyValidityChecker::isValid(const ob::State *state) const
{
    // for each obstacles
...
MyValidityChecker::~MyValidityChecker()
{
