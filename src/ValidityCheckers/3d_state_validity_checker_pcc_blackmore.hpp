...
class StateValidityCheckerPCCBlackmore3D : public ob::StateValidityChecker {
	public:
		StateValidityCheckerPCCBlackmore3D(const std::string &scene_id, const ob::SpaceInformationPtr &si, const double accep_prob);
		~StateValidityCheckerPCCBlackmore3D();
