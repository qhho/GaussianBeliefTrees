...
#include "guided_state_sampler_3d.hpp"
...
void GuidedStateSampler::sampleLeadSequentially(ob::State *state) {
  ...
  R3BeliefSpace::StateType *ostate_css_rss = state->as<CompoundState>()->operator[](0)->as<ob::CompoundStateSpace::StateType>()->as<R3BeliefSpace::StateType>(0);
  R3BeliefSpace::StateType *rstate_css_rss = states_to_sample_[k]->as<CompoundState>()->operator[](0)->as<ob::CompoundStateSpace::StateType>()->as<R3BeliefSpace::StateType>(0);
...
void GuidedStateSampler::sampleLeadDynamically(ob::State *state) {
  ...
  R3BeliefSpace::StateType *bstate_css_rss = bstate_->as<CompoundState>()->operator[](0)->as<ob::CompoundStateSpace::StateType>()->as<R3BeliefSpace::StateType>(0);
  R3BeliefSpace::StateType *rstate_css_rss = states_to_sample_[ref_idx_]->as<CompoundState>()->operator[](0)->as<ob::CompoundStateSpace::StateType>()->as<R3BeliefSpace::StateType>(0);
