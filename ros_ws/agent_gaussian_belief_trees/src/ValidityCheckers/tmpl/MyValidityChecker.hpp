...
#ifndef OMPL_CONTRIB_STATE_MY_VALIDITY_CHECKER
#define OMPL_CONTRIB_STATE_MY_VALIDITY_CHECKER
...
//!  HyperplaneStateMyValidityCheckerSE2V class.
/*!
...
public:
    ...
    MyValidityChecker(const ob::SpaceInformationPtr &si);

    //! Scenario3MyValidityChecker destructor.
    /*!
     * Destroy
     */
    ~MyValidityChecker();
