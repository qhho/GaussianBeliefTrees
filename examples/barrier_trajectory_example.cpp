...
int main()
{
    ...
    // Create the trajectory validity checker
    auto validity_checker = std::make_shared<BarrierTrajectoryValidityChecker>(si);
    
    // Set system matrices (example for a simple 2D system)
    ...
    // Set half-space constraints (example: stay within bounds)
